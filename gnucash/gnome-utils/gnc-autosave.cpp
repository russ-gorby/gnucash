/*
 * gnc-autosave.cpp -- Functions related to the auto-save feature.
 *
...
{
    auto book = static_cast<QofBook *>(user_data);
    bool save_now = true;
...
{
    auto key = const_cast<char*>(AUTOSAVE_SOURCE_ID);
    autosave_remove_timer_cb(book, key, qof_book_get_data(book, AUTOSAVE_SOURCE_ID));
}
