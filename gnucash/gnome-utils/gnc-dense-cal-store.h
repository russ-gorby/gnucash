...
GncDenseCalStore* gnc_dense_cal_store_new (int num_marks) NOEXCEPT;
void gnc_dense_cal_store_clear (GncDenseCalStore *model) NOEXCEPT;
void gnc_dense_cal_store_update_name (GncDenseCalStore *model, const gchar* name) NOEXCEPT;
void gnc_dense_cal_store_update_info (GncDenseCalStore *model, const gchar* info) NOEXCEPT;
