/********************************************************************\
 * dialog-file-access.cpp -- dialog for opening a file or making a    *
...
gnc_ui_file_access (GtkWindow *parent, int type)
{
    ...
    bool need_access_method_file = false;
    bool need_access_method_mysql = false;
    bool need_access_method_postgres = false;
    bool need_access_method_sqlite3 = false;
    bool need_access_method_xml = false;
    ...
    GtkFileChooserWidget *fileChooser = GTK_FILE_CHOOSER_WIDGET(gtk_file_chooser_widget_new( fileChooserAction ));
