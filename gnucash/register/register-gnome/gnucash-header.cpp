...
gnc_header_draw_offscreen (GncHeader *header)
{
    ...
    color_type = gnc_table_get_color (table, virt_loc, nullptr);
    gnucash_get_style_classes (header->sheet, stylectxt,
    ...
    cb = vcell ? vcell->cellblock : nullptr;
    row_offset = 0;
